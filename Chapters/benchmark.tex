...
All solvers except the irTF-MxNE are implemented in the MNE-python package~\cite{MNE}. The dipole fitting, MUSIC, dSPM, MNE, sLORETA, $\gamma$-map have used the by default version. The regularization parameter of LCMV was set to $reg=1$.
